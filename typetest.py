...
def game():
	...
	words = ['programming', 'coding', 'algorithm',
            ...
            'knowledge','idea','skills','analytics']
	...
	x2.place(x=150, y=10)
	x3 = Label(windows, text="START TYPING...vs", font="times 20")
	x3.place(x=10, y=50)
	...
	b2 = Button(windows, text="DONE",
				command=check_result, width=12, bg='green')
...
b1 = Button(window, text="Go", command=game, width=12, bg='red')
